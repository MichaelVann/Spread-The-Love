...
public class UpgradeTree
{
    ...
    UpgradeItem NewUpgrade(UpgradeId a_ID, string a_name, float a_cost, int a_maxLevel, float a_effectStrength, UpgradeItem a_precursorUpgrade, string a_description, bool a_toggleable = false, float a_costScaling = 1.2f)
    {
        UpgradeItem upgrade = new UpgradeItem(a_ID,a_name, (int)(a_cost * m_baseUpgradePrice), a_maxLevel, a_effectStrength, a_precursorUpgrade, a_description, a_toggleable, a_costScaling);
    ...
    void SetupUpgrades()
    {
        ...
        UpgradeItem bulletTime = NewUpgrade(UpgradeItem.UpgradeId.BulletTime, "Bullet Time", 3f, 10, 10f, additionalTime, "Slows time, allowing increased reaction time.");
